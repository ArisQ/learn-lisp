...
** Mutation & assignement & side effects
*** ~set!~
#+begin_src scheme :results output
(define chest 'sword)
(format #t "~a\n" chest)
...
: #t
: You attack Hobgoblin, doing 20 damage!
: #t
: Poor Hobgoblin is already dead!
: #t
: #t

** Scheme in Scheme
:PROPERTIES:
:header-args:scheme+: :session **scheme-in-scheme*
:END:
...
#+begin_example
newer-foo
((bar . bar-val) (quux . quux-val) (foo . foo-val))
#t
#f
33
-2/3
